...
$(function ($) {
    ...
    designSlider = new Swiper(galleryBlock.find('.swiper-container'), {
        loop: false,
        setWrapperSize: true,
        slidesPerView: 1,
        spaceBetween: 0,
        prevButton: galleryBlock.find('.swiper-button-prev'),
        nextButton: galleryBlock.find('.swiper-button-next'),
