    ...
    $.fn.mason = function (options, complete) {
        ...
        return this.each(function () {
            ...
            function setup() {
                ...
                elements.block.height = Math.floor((($self.width() / columnSize()) / settings.ratio).toFixed(0) - .55);
                elements.block.width = Math.floor(($self.width() / columnSize()));
//				elements.block.height = parseFloat((($self.width() / columnSize()) / settings.ratio).toFixed(0)-.5);
//				elements.block.width = parseFloat(($self.width() / columnSize())-.5);
